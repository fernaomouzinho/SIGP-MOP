...
from proc.models import Proc, ProcLet, ProcResTrack
...
def dnaProcResNext(request, pk):
	...
	track = ProcResTrack.objects.get(proc=proc)
...
def dgafProcResNext1(request, pk):
	...
	track.stages = "DGAF ba Gabinete Ministru"
	track.percent = 33
	track.save()
...
def gabProcResBack(request, hashid):
	...
	context = {
		'group': group, 'proc':proc, 'obj':obj, 'form':form, 'page':'res',
