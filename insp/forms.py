...
##
class InspForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['epos'].queryset = EmployeePos.objects.filter(position__id=7, cat='Inspeksaun').all()
...
class InspForm2(forms.ModelForm):
...
class InspForm3(forms.ModelForm):
...
#
class InspSecForm(forms.ModelForm):
    ...
    def __init__(self, sec, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['to'].queryset = Employee.objects.filter(employeepos__position_id=8, employeepos__cat='Inspeksaun', employeediv__sec=sec)\
...
class InspSecForm2(forms.ModelForm):
...
#
class InspEngForm(forms.ModelForm):
